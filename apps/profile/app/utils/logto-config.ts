import {
  getBaseLogtoConfig,
  organizationScopes,
} from "@ogcio/nextjs-auth/authentication-context";
import { logto } from "./routes";
import { AuthenticationContextConfig } from "@ogcio/nextjs-auth/base-authentication-context";
...
export const getSignInConfiguration = () => ({
  ...getBaseLogtoConfig(logtoParams),
...
export const logtoParams = {
  isProductionEnv: process.env.NODE_ENV === "production",
  logtoEndpoint: process.env.LOGTO_ENDPOINT as string,
  logtoCookieSecret: process.env.LOGTO_COOKIE_SECRET as string,
