...
export default async (props: NextPageProps) => {
  ...
  const mainUserContainer = await mainProfile.getUser(mainAuthContext.user.id);
  if (!mainUserContainer.data) {
    return notFound();
  }
  const mainUser = mainUserContainer.data;
    ...
    <div className="govie-grid-row">
      <div className="govie-grid-column-two-thirds">
        ...
        <form action={createAddress}>
          ...
          />
          <input type="hidden" name="email" defaultValue={mainUser.email} />
          <div
